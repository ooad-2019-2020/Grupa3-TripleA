...
namespace BibliotekaOOAD.Migrations
{
    ...
    [Migration("20200607184922_Migracija15")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BibliotekaOOAD.Models.Obavjestenje", b =>
                {
                    ...
                    b.Property<int?>("VipKorisnikDbId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BibliotekaOOAD.Models.Bibliotekar", b =>
                {
                    b.HasBaseType("BibliotekaOOAD.Models.Osoba");
            ...
            modelBuilder.Entity("BibliotekaOOAD.Models.Knjiga", b =>
                {
                    ...
                    b.HasOne("BibliotekaOOAD.Models.Bibliotekar", null)
                        .WithMany("KnjigeIzSedmicnePreporuke")
            ...
            modelBuilder.Entity("BibliotekaOOAD.Models.Obavjestenje", b =>
                {
                    ...
                    b.HasOne("BibliotekaOOAD.Models.VipKorisnikDb", null)
                        .WithMany("Obavjestenja")
                        .HasForeignKey("VipKorisnikDbId");
                });
