...
namespace BibliotekaOOAD.Controllers
{
    public class AdministratorController : Controller
    {
        ...
        public AdministratorController(TripleContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("BrojLoginova,Id,Lozinka,Ime,Prezime,Email")] Administrator administrator)
        {
